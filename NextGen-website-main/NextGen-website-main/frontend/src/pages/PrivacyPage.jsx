      ...
      <section className="ngi-page-hero max-w-3xl">
        <FadeIn>
          ...
          <div className="mt-12 text-[#1E1E1E]/85 leading-relaxed space-y-6">
            ...
            <h2 className="ngi-section-heading mt-12">What we collect</h2>
            ...
            <h2 className="ngi-section-heading mt-10">How we use it</h2>
            ...
            <h2 className="ngi-section-heading mt-10">Cookies</h2>
            ...
            <h2 className="ngi-section-heading mt-10">Retention</h2>
            ...
            <h2 className="ngi-section-heading mt-10">Your rights</h2>
            ...
            <h2 className="ngi-section-heading mt-10">Contact</h2>
